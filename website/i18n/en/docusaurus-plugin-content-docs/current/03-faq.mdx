...
items see ["What Is Supported?" section](/faq)
...
is done so that `@dodge164/react-yandex-maps` library can keep track of size changes
and call special Map method to fit the Map UI into available view.
